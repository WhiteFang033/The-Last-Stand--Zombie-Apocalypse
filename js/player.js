class Player extends Sprite{
    ...
    update(){
        ...
        else if((this.position.y + this.height + boxes[0].height >= (canvas.height - this.velocity.y - 44)) && (this.position.x-boxes[0].position.x)>=0 &&(this.position.x-boxes[0].position.x)<= boxDimensions.width){
            this.velocity.y = 0;
            onGround = true;
        }
        else if((this.position.y + this.height + boxes[1].height >= (canvas.height - this.velocity.y - 44)) && (this.position.x-boxes[1].position.x)>=0 &&(this.position.x-boxes[1].position.x)<= boxDimensions.width){
            this.velocity.y = 0;
            onGround = true;
        }
        else{
